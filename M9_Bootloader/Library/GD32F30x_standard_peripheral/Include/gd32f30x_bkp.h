...
/* BKP_TPCS */
#define BKP_TPCTL_TER                 BIT(0)                   /*!< tamper event reset */
#define BKP_TPCTL_TIR                 BIT(1)                   /*!< tamper interrupt reset */
#define BKP_TPCTL_TPIE                BIT(2)                   /*!< tamper interrupt enable */
#define BKP_TPCTL_TEF                 BIT(8)                   /*!< tamper event flag */
#define BKP_TPCTL_TIF                 BIT(9)                   /*!< tamper interrupt flag */
...
#define BKP_FLAG_TEF                  BKP_TPCTL_TEF            /*!< tamper event flag */
#define BKP_FLAG_TIF                  BKP_TPCTL_TIF            /*!< tamper interrupt flag */
