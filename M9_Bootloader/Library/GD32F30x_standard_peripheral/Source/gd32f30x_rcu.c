...
/*!
    ...
    \param[in]  ckout0_src: CK_OUT0 clock source selection
                only one parameter can be selected which is shown as below:
      \arg        RCU_CKOUT0SRC_NOSRC: no clock selected
...
/*!
    ...
    \param[in]  pll_src: PLL clock source selection
      \arg        RCU_PLLSEL_IRC8M_DIV2: IRC8M/2 clock selected as source clock of PLL
      \arg        RCU_PLLSEL_HXTAL_IRC48M: HXTAL or IRC48M selected as source clock of PLL
...
/*!
    ...
    \param[in]  pll_presel: PLL clock source preselection
      \arg        RCU_PLLPRESEL_HXTAL: HXTAL selected as PLL source clock
      \arg        RCU_PLLPRESEL_IRC48M: CK_PLL selected as PREDV0 input source clock
    \param[out] none
    \retval     none
*/
...
void rcu_predv0_config(uint32_t predv0_div)
{
    ...
    /* reset PREDV0 bit */
    reg &= ~RCU_CFG0_PREDV0;
    if(RCU_PREDV0_DIV_2 == predv0_div){
        /* set the PREDV0 bit */
        reg |= RCU_CFG0_PREDV0;
    }
...
/*!
    ...
    \param[in]  predv0_source: PREDV0 input clock source selection
      \arg        RCU_PREDV0SEL_HXTAL_IRC48M: HXTAL or IRC48M selected as PREDV0 input source clock
      \arg        RCU_PREDV0SEL_CKPLL1: CK_PLL1 selected as PREDV0 input source clock
    \param[in]  predv0_div: PREDV0 division factor
      \arg        RCU_PREDV0_DIV_x, x = NONE, 2..16
    \param[out] none
    \retval     none
*/
...
/*!
    ...
    \param[in]  predv1_div: PREDV1 division factor
      \arg        RCU_PREDV1_DIV_x, x = NONE, 2..16
    \param[out] none
    \retval     none
*/
...
/*!
    ...
    \param[in]  i2s_clock_source: I2S1 clock source selection
                only one parameter can be selected which is shown as below:
      \arg        RCU_I2S1SEL_CKSYS: System clock selected as I2S1 source clock
      \arg        RCU_I2S1SEL_CKPLL2_MUL_2: CK_PLL2x2 selected as I2S1 source clock
    \param[out] none
    \retval     none
*/
...
/*!
    ...
    \param[in]  i2s_clock_source: I2S2 clock source selection
                only one parameter can be selected which is shown as below:
      \arg        RCU_I2S2SEL_CKSYS: system clock selected as I2S2 source clock
      \arg        RCU_I2S2SEL_CKPLL2_MUL_2: CK_PLL2x2 selected as I2S2 source clock
    \param[out] none
    \retval     none
*/
...
/*!
    ...
    \param[in]  ck48m_clock_source: CK48M clock source selection
                only one parameter can be selected which is shown as below:
      \arg        RCU_CK48MSEL_CKPLL: CK_PLL selected as CK48M source clock
      \arg        RCU_CK48MSEL_IRC48M: CK_IRC48M selected as CK48M source clock
    \param[out] none
    \retval     none
*/
...
uint32_t rcu_clock_freq_get(rcu_clock_freq_enum clock)
{
    ...
    case SEL_PLL:
        ...
        if(RCU_PLLSEL_HXTAL_IRC48M == pllsel) {
            ...
            if(RCU_PREDV0SEL_CKPLL1 == predv0sel){
