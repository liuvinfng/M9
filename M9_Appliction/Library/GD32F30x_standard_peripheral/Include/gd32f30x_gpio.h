...
#define AFIO_PCF0_SWJ_CFG                BITS(24,26)         /*!< serial wire JTAG configuration */
#define AFIO_PCF0_SWD_CFG                BITS(25)            /*!< serial wire JTAG configuration */
#define AFIO_PCF0_SPI2_REMAP             BIT(28)             /*!< SPI2 remapping */
#endif /* GD32F30X_CL */
...
/* AFIO_PCF1 */
#define AFIO_PCF1_TIMER8_REMAP           BITS(5)             /*!< TIMER8 remapping */
#define AFIO_PCF1_TIMER9_REMAP           BITS(6)             /*!< TIMER9 remapping */
#define AFIO_PCF1_TIMER10_REMAP          BITS(7)             /*!< TIMER10 remapping */
#define AFIO_PCF1_TIMER12_REMAP          BITS(8)             /*!< TIMER12 remapping */
#define AFIO_PCF1_TIMER13_REMAP          BITS(9)             /*!< TIMER13 remapping */
#define AFIO_PCF1_FSMC_NADV              BITS(10)            /*!< FSMC_NADV connect/disconnect */
...
#define GPIO_EVENT_PIN_0                 ((uint8_t)0x00U)          /*!< GPIO pin 0 */
#define GPIO_EVENT_PIN_1                 ((uint8_t)0x01U)          /*!< GPIO pin 1 */
#define GPIO_EVENT_PIN_2                 ((uint8_t)0x02U)          /*!< GPIO pin 2 */
#define GPIO_EVENT_PIN_3                 ((uint8_t)0x03U)          /*!< GPIO pin 3 */
#define GPIO_EVENT_PIN_4                 ((uint8_t)0x04U)          /*!< GPIO pin 4 */
#define GPIO_EVENT_PIN_5                 ((uint8_t)0x05U)          /*!< GPIO pin 5 */
#define GPIO_EVENT_PIN_6                 ((uint8_t)0x06U)          /*!< GPIO pin 6 */
#define GPIO_EVENT_PIN_7                 ((uint8_t)0x07U)          /*!< GPIO pin 7 */
#define GPIO_EVENT_PIN_8                 ((uint8_t)0x08U)          /*!< GPIO pin 8 */
#define GPIO_EVENT_PIN_9                 ((uint8_t)0x09U)          /*!< GPIO pin 9 */
#define GPIO_EVENT_PIN_10                ((uint8_t)0x0AU)          /*!< GPIO pin 10 */
#define GPIO_EVENT_PIN_11                ((uint8_t)0x0BU)          /*!< GPIO pin 11 */
#define GPIO_EVENT_PIN_12                ((uint8_t)0x0CU)          /*!< GPIO pin 12 */
#define GPIO_EVENT_PIN_13                ((uint8_t)0x0DU)          /*!< GPIO pin 13 */
#define GPIO_EVENT_PIN_14                ((uint8_t)0x0EU)          /*!< GPIO pin 14 */
#define GPIO_EVENT_PIN_15                ((uint8_t)0x0FU)          /*!< GPIO pin 15 */
...
void gpio_compensation_config(uint32_t gpio_compensation); 
