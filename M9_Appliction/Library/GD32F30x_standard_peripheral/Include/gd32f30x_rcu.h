...
typedef enum
{
    ...
    RCU_FLAG_IRC8MSTB      = RCU_REGIDX_BIT(CTL_REG_OFFSET, 2U),            /*!< IRC8M stabilization flags */
...
#define RCU_CKADC_CKAPB2_DIV2           ((uint32_t)0x00000000)              /*!< ADC prescaler select CK_APB2/2 */
#define RCU_CKADC_CKAPB2_DIV4           ((uint32_t)0x00000001)              /*!< ADC prescaler select CK_APB2/4 */
#define RCU_CKADC_CKAPB2_DIV6           ((uint32_t)0x00000002)              /*!< ADC prescaler select CK_APB2/6 */
#define RCU_CKADC_CKAPB2_DIV8           ((uint32_t)0x00000003)              /*!< ADC prescaler select CK_APB2/8 */
#define RCU_CKADC_CKAPB2_DIV12          ((uint32_t)0x00000005)              /*!< ADC prescaler select CK_APB2/12 */
#define RCU_CKADC_CKAPB2_DIV16          ((uint32_t)0x00000007)              /*!< ADC prescaler select CK_APB2/16 */
#define RCU_CKADC_CKAHB_DIV5            ((uint32_t)0x00000008)              /*!< ADC prescaler select CK_AHB/5 */
#define RCU_CKADC_CKAHB_DIV6            ((uint32_t)0x00000009)              /*!< ADC prescaler select CK_AHB/6 */
#define RCU_CKADC_CKAHB_DIV10           ((uint32_t)0x0000000A)              /*!< ADC prescaler select CK_AHB/10 */
#define RCU_CKADC_CKAHB_DIV20           ((uint32_t)0x0000000B)              /*!< ADC prescaler select CK_AHB/20 */

/* PLL clock source selection */
#define RCU_PLLSEL_IRC8M_DIV2           ((uint32_t)0x00000000U)             /*!< IRC8M/2 clock selected as source clock of PLL */
#define RCU_PLLSEL_HXTAL_IRC48M         RCU_CFG0_PLLSEL                     /*!< HXTAL or IRC48M selected as source clock of PLL */
...
#define RCU_CKOUT0SRC_NOSRC             CFG0_CKOUT0SEL(0)                   /*!< no clock selected */
...
#define RCU_PREDV0_DIV_NONE             CFG1_PREDV0(0)                      /*!< PREDV0 input source clock not divided */
#define RCU_PREDV0_DIV_2                CFG1_PREDV0(1)                      /*!< PREDV0 input source clock divided by 2 */
#define RCU_PREDV0_DIV_3                CFG1_PREDV0(2)                      /*!< PREDV0 input source clock divided by 3 */
#define RCU_PREDV0_DIV_4                CFG1_PREDV0(3)                      /*!< PREDV0 input source clock divided by 4 */
#define RCU_PREDV0_DIV_5                CFG1_PREDV0(4)                      /*!< PREDV0 input source clock divided by 5 */
#define RCU_PREDV0_DIV_6                CFG1_PREDV0(5)                      /*!< PREDV0 input source clock divided by 6 */
#define RCU_PREDV0_DIV_7                CFG1_PREDV0(6)                      /*!< PREDV0 input source clock divided by 7 */
#define RCU_PREDV0_DIV_8                CFG1_PREDV0(7)                      /*!< PREDV0 input source clock divided by 8 */
#define RCU_PREDV0_DIV_9                CFG1_PREDV0(8)                      /*!< PREDV0 input source clock divided by 9 */
#define RCU_PREDV0_DIV_10               CFG1_PREDV0(9)                      /*!< PREDV0 input source clock divided by 10 */
#define RCU_PREDV0_DIV_11               CFG1_PREDV0(10)                     /*!< PREDV0 input source clock divided by 11 */
#define RCU_PREDV0_DIV_12               CFG1_PREDV0(11)                     /*!< PREDV0 input source clock divided by 12 */
#define RCU_PREDV0_DIV_13               CFG1_PREDV0(12)                     /*!< PREDV0 input source clock divided by 13 */
#define RCU_PREDV0_DIV_14               CFG1_PREDV0(13)                     /*!< PREDV0 input source clock divided by 14 */
#define RCU_PREDV0_DIV_15               CFG1_PREDV0(14)                     /*!< PREDV0 input source clock divided by 15 */
#define RCU_PREDV0_DIV_16               CFG1_PREDV0(15)                     /*!< PREDV0 input source clock divided by 16 */

/* PREDV1 division factor */
#define CFG1_PREDV1(regval)             (BITS(4,7) & ((uint32_t)(regval) << 4))
#define RCU_PREDV1_DIV_NONE             CFG1_PREDV1(0)                      /*!< PREDV1 input source clock not divided */
#define RCU_PREDV1_DIV_2                CFG1_PREDV1(1)                      /*!< PREDV1 input source clock divided by 2 */
#define RCU_PREDV1_DIV_3                CFG1_PREDV1(2)                      /*!< PREDV1 input source clock divided by 3 */
#define RCU_PREDV1_DIV_4                CFG1_PREDV1(3)                      /*!< PREDV1 input source clock divided by 4 */
#define RCU_PREDV1_DIV_5                CFG1_PREDV1(4)                      /*!< PREDV1 input source clock divided by 5 */
#define RCU_PREDV1_DIV_6                CFG1_PREDV1(5)                      /*!< PREDV1 input source clock divided by 6 */
#define RCU_PREDV1_DIV_7                CFG1_PREDV1(6)                      /*!< PREDV1 input source clock divided by 7 */
#define RCU_PREDV1_DIV_8                CFG1_PREDV1(7)                      /*!< PREDV1 input source clock divided by 8 */
#define RCU_PREDV1_DIV_9                CFG1_PREDV1(8)                      /*!< PREDV1 input source clock divided by 9 */
#define RCU_PREDV1_DIV_10               CFG1_PREDV1(9)                      /*!< PREDV1 input source clock divided by 10 */
#define RCU_PREDV1_DIV_11               CFG1_PREDV1(10)                     /*!< PREDV1 input source clock divided by 11 */
#define RCU_PREDV1_DIV_12               CFG1_PREDV1(11)                     /*!< PREDV1 input source clock divided by 12 */
#define RCU_PREDV1_DIV_13               CFG1_PREDV1(12)                     /*!< PREDV1 input source clock divided by 13 */
#define RCU_PREDV1_DIV_14               CFG1_PREDV1(13)                     /*!< PREDV1 input source clock divided by 14 */
#define RCU_PREDV1_DIV_15               CFG1_PREDV1(14)                     /*!< PREDV1 input source clock divided by 15 */
#define RCU_PREDV1_DIV_16               CFG1_PREDV1(15)                     /*!< PREDV1 input source clock divided by 16 */
...
#define RCU_PREDV0SEL_HXTAL_IRC48M      ((uint32_t)0x00000000)              /*!< HXTAL or IRC48M selected as PREDV0 input source clock */
#define RCU_PREDV0SEL_CKPLL1            RCU_CFG1_PREDV0SEL                  /*!< CK_PLL1 selected as PREDV0 input source clock */

/* I2S1 clock source selection */
#define RCU_I2S1SEL_CKSYS               ((uint32_t)0x00000000)              /*!< system clock selected as I2S1 source clock */
#define RCU_I2S1SEL_CKPLL2_MUL_2        RCU_CFG1_I2S1SEL                    /*!< (CK_PLL2 x 2) selected as I2S1 source clock */

/* I2S2 clock source selection */
#define RCU_I2S2SEL_CKSYS               ((uint32_t)0x00000000)              /*!< system clock selected as I2S2 source clock */
#define RCU_I2S2SEL_CKPLL2_MUL_2        RCU_CFG1_I2S2SEL                    /*!< (CK_PLL2 x 2) selected as I2S2 source clock */
#endif /* GD32F30X_CL */

/* PLL input clock source selection */
#define RCU_PLLPRESEL_HXTAL             ((uint32_t)0x00000000)              /*!< HXTAL selected as PLL source clock */
#define RCU_PLLPRESEL_IRC48M            RCU_CFG1_PLLPRESEL                  /*!< CK_PLL selected as PREDV0 input source clock */
...
#define RCU_CK48MSEL_CKPLL              ((uint32_t)0x00000000)              /*!< use CK_PLL clock */
#define RCU_CK48MSEL_IRC48M             RCU_ADDCTL_CK48MSEL                 /*!< select IRC48M clock */
